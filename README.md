...
- **Schedule** — Visual scheduler with Pump High/Low speed commands, Pump On/Off, Heater On/Off, Lights Off, OneTouch presets. Sorted by time. Bulk **All On / All Off** button. Custom OneTouch labels shown. Edit/delete/toggle per schedule. Runs on Cloudflare Worker cron (every minute, Pacific time)
